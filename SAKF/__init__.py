...
def s_bank(start, j, e, p, name):
    return [main.s_call, [
        s_segment(name),
        s_ifdef("VERSION_J00"),
        s_bin(start, j, "J00_%s" % name, "J00"),
        s_endif("VERSION_J00"),
        s_ifdef("VERSION_E00"),
        s_bin(start, e, "E00_%s" % name, "E00"),
        s_endif("VERSION_E00"),
        s_ifdef("VERSION_P00"),
        s_bin(start, p, "P00_%s" % name, "P00"),
        s_endif("VERSION_P00"),
    ]]
...
src_code = [
    ...
    s_ifndef("VERSION_J00"),
        s_code(0x008A9B, 0x008AC0, "E00"),
    s_endif("VERSION_J00"),
    ...
    s_ifndef("VERSION_J00", 1, 0),
        s_code(0x008D37, 0x008D4F, "E00"),
        s_data(0x008D4F, 0x008D6F, [[4, 4, hvc.asm.d_word]], "E00"),
    s_endif("VERSION_J00", 0, 1),
...
src_code_01 = [
    ...
    s_ifndef("VERSION_J00"),
        s_code(0x01E046, 0x01E04B, "E00"),
        s_code(0x01E04B, 0x01E04B, "E00"),
    s_endif("VERSION_J00"),
    s_code(0x01E11E, 0x01E144),
    s_ifndef("VERSION_J00"),
        s_code(0x01E071, 0x01E077, "E00"),
    s_endif("VERSION_J00"),
    ...
    s_else("VERSION_J00"),
        s_code(0x01E08B, 0x01E08E, "E00"),
    s_endif("VERSION_J00"),
    s_code(0x01E160, 0x01E167),
    s_ifdef("VERSION_J00"),
        s_code(0x01E167, 0x01E16A),
    s_else("VERSION_J00"),
        s_code(0x01E095, 0x01E098, "E00"),
    s_endif("VERSION_J00"),
    ...
    s_else("VERSION_J00"),
        s_code(0x01E131, 0x01E132, "E00", p=0x20),
    s_endif("VERSION_J00"),
    ...
    s_ifndef("VERSION_J00"),
        s_data(0x01E860, 0x01E920, [[24, 8, hvc.asm.d_byte]], "E00"),
    s_endif("VERSION_J00"),
...
lst = [
    [main.s_data, "J00", ["donor", "SAKFJ00.sfc"]],
    [main.s_data, "E00", ["donor", "SAKFE00.sfc"]],
    [main.s_data, "P00", ["donor", "SAKFP00.sfc"]],
