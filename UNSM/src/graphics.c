...
static void gfx_make_task(void)
{
    ...
    gfx_task->task.t.dram_stack = gfx_stack;
    gfx_task->task.t.dram_stack_size = sizeof(gfx_stack);
    ...
    gfx_task->task.t.yield_data_ptr = gfx_yield;
    gfx_task->task.t.yield_data_size = sizeof(gfx_yield);
}
