...
def s_code(start, end, fn, include=[], s=str_code, macro=True, sep=False):
    return [main.s_call, [
        [main.s_file, "%s.S" % fn],
            s_include(include),
            [main.s_str, s],
...
ultra_src = [
    ...
    [main.s_write],
    s_code(0x803223B0, 0x803223D4, "settime",               ["ultra64"], str_code,   False),
    s_code(0x803223E0, 0x80322494, "maptlb",                ["ultra64"], str_code,   False),
    s_code(0x803224A0, 0x803224E4, "unmaptlball",           ["ultra64"], str_code,   False),
    s_code(0x803224F0, 0x80322594, "sprintf",               ["ultra64"], str_code,   False),
    s_code(0x803225A0, 0x803225CC, "createmesgqueue",       ["ultra64"], str_code,   False),
    s_code(0x803225D0, 0x80322638, "seteventmesg",          ["ultra64"], str_code,   False),
    s_code(0x80322640, 0x803226AC, "visetevent",            ["ultra64"], str_code,   False),
    s_code(0x803226B0, 0x803227F4, "createthread",          ["ultra64"], str_code,   False),
    s_code(0x80322800, 0x80322938, "recvmesg",              ["ultra64"], str_code,   False),
    s_code(0x80322940, 0x80322BFC, "sptask",                ["ultra64"], str_code,   False),
    s_code(0x80322C00, 0x80322C20, "sptaskyield",           ["ultra64"], str_code,   False),
    s_code(0x80322C20, 0x80322D6C, "sendmesg",              ["ultra64"], str_code,   False),
    s_code(0x80322D70, 0x80322DF0, "sptaskyielded",         ["ultra64"], str_code,   False),
    s_code(0x80322DF0, 0x80322F40, "startthread",           ["ultra64"], str_code,   False),
    s_code(0x80322F40, 0x80322F68, "writebackdcacheall",    ["ultra64"], str_code,   False),
    s_code(0x80322F70, 0x803232C4, "vimgr",                 ["ultra64"], str_code,   False),
    s_code(0x803232D0, 0x80323338, "visetmode",             ["ultra64"], str_code,   False),
    s_code(0x80323340, 0x803233B0, "viblack",               ["ultra64"], str_code,   False),
    s_code(0x803233B0, 0x80323568, "visetspecial",          ["ultra64"], str_code,   False),
    s_code(0x80323570, 0x803236EC, "pimgr",                 ["ultra64"], str_code,   False),
    s_code(0x803236F0, 0x803237D0, "setthreadpri",          ["ultra64"], str_code,   False),
    s_code(0x803237D0, 0x80323A00, "initialize",            ["ultra64"], str_code,   False),
    s_code(0x80323A00, 0x80323A50, "viswapbuf",             ["ultra64"], str_code,   False),
    s_code(0x80323A50, 0x80323A58, "sqrtf",                 ["ultra64"], str_code,   False),
    s_code(0x80323A60, 0x80323CB8, "contreaddata",          ["ultra64"], str_code,   False),
    s_code(0x80323CC0, 0x80324080, "controller",            ["ultra64"], str_code,   False),
    s_code(0x80324080, 0x803240EC, "conteepprobe",          ["ultra64"], str_code,   False),
    s_code(0x803240F0, 0x803243B0, "ll",                    ["ultra64"], str_code_g, False),
    s_code(0x803243B0, 0x8032445C, "invaldcache",           ["ultra64"], str_code,   False),
    s_code(0x80324460, 0x80324564, "pidma",                 ["ultra64"], str_code,   False),
    s_code(0x80324570, 0x8032460C, "bzero",                 ["ultra64"], str_code,   False),
    s_code(0x80324610, 0x80324684, "invalicache",           ["ultra64"], str_code,   False),
    s_code(0x80324690, 0x803247CC, "conteeplongread",       ["ultra64"], str_code,   False),
    ...
    s_code(0x80325970, 0x80325AD0, "aisetfreq",             ["ultra64"], str_code,   False),
    s_code(0x80325AD0, 0x80325D18, "bnkf",                  ["ultra64"], str_code,   False),
    s_code(0x80325D20, 0x80325D94, "writebackdcache",       ["ultra64"], str_code,   False),
    s_code(0x80325DA0, 0x80325DAC, "aigetlen",              ["ultra64"], str_code,   False),
    s_code(0x80325DB0, 0x80325E58, "aisetnextbuf",          ["ultra64"], str_code,   False),
    s_code(0x80325E60, 0x80326260, "timerintr",             ["ultra64"], str_code,   False),
    s_code(0x80326260, 0x803273E4, "xprintf",               ["ultra64"], str_code,   False),
    s_code(0x803273F0, 0x80327484, "string",                ["ultra64"], str_code,   False),
    s_code(0x80327490, 0x803274D0, "thread",                ["ultra64"], str_code,   False),
    s_code(0x803274D0, 0x8032750C, "interrupt",             ["ultra64"], str_code,   False),
    s_code(0x80327510, 0x80327634, "vi",                    ["ultra64"], str_code,   False),
    s_code(0x80327640, 0x80327EB0, "exceptasm",             ["ultra64"], str_code_g, False),
    s_code(0x80327EB0, 0x80327F2C, "virtualtophysical",     ["ultra64"], str_code,   False),
    s_code(0x80327F30, 0x80327F3C, "spsetstat",             ["ultra64"], str_code,   False),
    s_code(0x80327F40, 0x80327F74, "spsetpc",               ["ultra64"], str_code,   False),
    s_code(0x80327F80, 0x8032800C, "sprawdma",              ["ultra64"], str_code,   False),
    s_code(0x80328010, 0x8032803C, "sp",                    ["ultra64"], str_code,   False),
    s_code(0x80328040, 0x8032804C, "spgetstat",             ["ultra64"], str_code,   False),
    s_code(0x80328050, 0x80328068, "getthreadpri",          ["ultra64"], str_code,   False),
    s_code(0x80328070, 0x8032807C, "vigetcurrcontext",      ["ultra64"], str_code,   False),
    s_code(0x80328080, 0x803283DC, "viswapcontext",         ["ultra64"], str_code,   False),
    s_code(0x803283E0, 0x803283EC, "getcount",              ["ultra64"], str_code,   False),
    s_code(0x803283F0, 0x803284B0, "piacs",                 ["ultra64"], str_code,   False),
    s_code(0x803284B0, 0x80328590, "pirawdma",              ["ultra64"], str_code,   False),
    s_code(0x80328590, 0x80328704, "devmgr",                ["ultra64"], str_code,   False),
    s_code(0x80328710, 0x80328720, "setsr",                 ["ultra64"], str_code,   False),
    s_code(0x80328720, 0x8032872C, "getsr",                 ["ultra64"], str_code,   False),
    s_code(0x80328730, 0x80328740, "setfpccsr",             ["ultra64"], str_code,   False),
    s_code(0x80328740, 0x80328790, "sirawread",             ["ultra64"], str_code,   False),
    s_code(0x80328790, 0x803287DC, "sirawwrite",            ["ultra64"], str_code,   False),
    s_code(0x803287E0, 0x80328838, "maptlbrdb",             ["ultra64"], str_code,   False),
    s_code(0x80328840, 0x80328894, "pirawread",             ["ultra64"], str_code,   False),
    s_code(0x803288A0, 0x80328960, "siacs",                 ["ultra64"], str_code,   False),
    s_code(0x80328960, 0x80328A0C, "sirawdma",              ["ultra64"], str_code,   False),
    s_code(0x80328A10, 0x80328AE4, "settimer",              ["ultra64"], str_code,   False),
    s_code(0x80328AF0, 0x80328FD0, "conteepwrite",          ["ultra64"], str_code,   False),
    s_code(0x80328FD0, 0x80329120, "jammesg",               ["ultra64"], str_code,   False),
    s_code(0x80329120, 0x80329148, "pigetcmdq",             ["ultra64"], str_code,   False),
    s_code(0x80329150, 0x80329444, "conteepread",           ["ultra64"], str_code,   False),
    s_code(0x80329450, 0x803296BC, "mtx",                   ["ultra64"], str_code,   False),
    s_code(0x803296C0, 0x80329744, "normalize",             ["ultra64"], str_code,   False),
    ...
    s_code(0x8032AE70, 0x8032AF68, "destroythread",         ["ultra64"], str_code,   False),
    s_code(0x8032AF70, 0x8032B028, "probetlb",              ["ultra64"], str_code,   False),
    s_code(0x8032B030, 0x8032B05C, "si",                    ["ultra64"], str_code,   False),
    s_code(0x8032B060, 0x8032B1E4, "ldiv",                  ["ultra64"], str_code,   False),
    s_code(0x8032B1F0, 0x8032B1FC, "getcause",              ["ultra64"], str_code,   False),
    s_code(0x8032B200, 0x8032B258, "atomic",                ["ultra64"], str_code,   False),
...
ultra_PR = [
    s_code(0x80246000, 0x80246050, "crt0", ["ultra64"], str_code, False),
    [main.s_addr, 0],
    [main.s_file, "mask.S"],
        [ultra.asm.s_header, "E0"],
    [main.s_write],
    [main.s_addr, 0xA4000000-0x00000000],
    s_code(0xA4000040, 0xA4000B6C, "ipl3", ["ultra64"], str_code+"\n", False),
...
src_main = [
    ...
    s_code(0x80263E60, 0x80269F38, "pl_walk", ["sm64/types"], str_code_f),
    ...
    s_code(0x8029C780, 0x8029D884, "object", ["sm64/types", "sm64/player", "sm64/object"], str_code_f),
    s_code(0x8029D890, 0x802A5618, "obj_lib", ["sm64/types", "sm64/object"], str_code_f),
    s_code(0x802A5620, 0x802C89F0, "object_a", ["sm64/types", "sm64/hud", "sm64/object", "sm64/obj_lib", "sm64/object_a"], str_code_f),
    ...
    s_code(0x802CB5C0, 0x802CD27C, "wipe", ["sm64/types"], str_code_f),
    s_code(0x802CD280, 0x802CF5A4, "shadow", ["sm64/types", "sm64/shadow"], str_code_f),
    s_code(0x802CF5B0, 0x802D007C, "background", ["sm64/types", "sm64/background"], str_code_f),
    s_code(0x802D0080, 0x802D2208, "scroll", ["sm64/types", "sm64/scroll"], str_code_f),
    s_code(0x802D2210, 0x802D29BC, "obj_shape", ["sm64/types", "sm64/hud"], str_code_f),
    s_code(0x802D29C0, 0x802D5E00, "ripple", ["sm64/types"], str_code_f),

    # s_code(0x802D5E00, 0x802D6F18, "dprint", ["sm64/types"]),
    s_code(0x802D6F20, 0x802DDDEC, "message", ["sm64/types", "sm64/hud"], str_code_f),
    ...
    s_code(0x802E3E50, 0x802F972C, "object_b", ["sm64/types", "sm64/object", "sm64/hud"], str_code_f),
...
src_main2 = [
    s_code(0x80378800, 0x8037B21C, "math", ["sm64/types"], str_code_f),
    ...
    s_code(0x80382490, 0x80383B6C, "map_data", ["sm64/types"], str_code_f),
    s_code(0x80383B70, 0x80385F88, "o_script", ["sm64/types"], str_code_f),
...
src_menu = [
    ...
    s_code(0x80170280, 0x801768E0, "file_select", ["sm64/types"], str_code_f),
    s_code(0x801768E0, 0x80177710, "star_select", ["sm64/types"], str_code_f),
...
src_audio = [
    ...
    s_code(0x8031E4F0, 0x80322364, "g", ["sm64/types"], str_code_f),
...
src_face = [
    ...
    s_code(0x80177820, 0x801781DC, "mem", ["sm64/types"], str_code_f),
    s_code(0x801781E0, 0x80178278, "sfx", ["sm64/types"]),
    s_code(0x80178280, 0x8017BDE4, "draw", ["sm64/types"], str_code_f),
    s_code(0x8017BDF0, 0x80181718, "object", ["sm64/types"], str_code_f),
    s_code(0x80181720, 0x80181D38, "skin", ["sm64/types"], str_code_f),
    s_code(0x80181D40, 0x80183A48, "particle", ["sm64/types"], str_code_f),
    s_code(0x80183A50, 0x8018B830, "dynlist", ["sm64/types"], str_code_f),
    s_code(0x8018B830, 0x8018C2F0, "gadget", ["sm64/types"], str_code_f),
    s_code(0x8018C2F0, 0x8018E660, "stdio", ["sm64/types"], str_code_f),
    s_code(0x8018E660, 0x80192050, "joint", ["sm64/types"], str_code_f),
    s_code(0x80192050, 0x80193C70, "net", ["sm64/types"], str_code_f),
    s_code(0x80193C70, 0x801973C0, "math", ["sm64/types"], str_code_f),
    s_code(0x801973C0, 0x8019B060, "shape", ["sm64/types"], str_code_f),
    s_code(0x8019B060, 0x801A7830, "gfx", ["sm64/types"], str_code_f),
    ...
    [main.s_dir, "include"],
        ...
        [main.s_dir, "sm64"],
            ...
            [main.s_dir, "audio"],
                ...
                s_header(
                    "file",
                    asm=[[main.s_str, header.str_audio_file_s]]
                ),
            [main.s_pop],
