...
#define shape_layer_get(shp)  ((shp)->flag >> 8)
...
#define MAP_EXT_AY              1
#define MAP_EXT_AY_ARG          2
#define MAP_EXT_XYZ             3
#define MAP_EXT_AY_CODE         4
...
struct_shp = [
	[0x1C, "struct", "s_callback", [
		(0x00, table.sym_var("s", "SHAPE")),
		(0x14, table.sym_var("callback", "SHPCALL *")),
		(0x18, table.sym_var("arg", "uintptr_t")),
	]],
	[0x18, "struct", "s_gfx", [
		(0x00, table.sym_var("s", "SHAPE")),
	...
	[0x24, "struct", "s_persp", [
		(0x00, table.sym_var("s", "S_CALLBACK")),
	...
	[0x20, "struct", "s_select", [
		(0x00, table.sym_var("s", "S_CALLBACK")),
		(0x1C, table.sym_var("code", "s16")),
		(0x1E, table.sym_var("index", "s16")),
	]],
	[0x3C, "struct", "s_camera", [
		(0x00, table.sym_var("s", "S_CALLBACK")),
		(0x1C, table.sym_var("eye", "VECF")),
		(0x28, table.sym_var("look", "VECF")),
		(0x34, table.sym_var("mf", "MTXF *")),
		(0x38, table.sym_var("az_m", "short")),
		(0x3A, table.sym_var("az_p", "short")),
	]],
	[0x24, "struct", "s_coord", [
		(0x00, table.sym_var("s", "S_GFX")),
	...
	[0x20, "struct", "spawn", [
		...
		(0x18, table.sym_var("shape", "SHAPE *")),
		(0x1C, table.sym_var("next", "struct spawn *")),
	]],
	[0x60, "struct", "s_object", [
		(0x00, table.sym_var("s", "SHAPE")),
		...
		(0x4C, table.sym_var("spawn", "SPAWN *")),
	...
	[0x1E, "struct", "s_billboard", [
		(0x00, table.sym_var("s", "S_GFX")),
		(0x18, table.sym_var("pos", "VECS")),
	]],
	[0x18, "struct", "s_shadow", [
		(0x00, table.sym_var("s", "SHAPE")),
	...
	[0x20, "struct", "s_back", [
		(0x00, table.sym_var("s", "S_CALLBACK")),
		(0x1C, table.sym_var("code", "u32")),
	]],
	[0x26, "struct", "s_hand", [
		(0x00, table.sym_var("s", "S_CALLBACK")),
		(0x1C, table.sym_var("obj", "S_OBJECT *")),
...
struct_object = [
	[0x68, "struct", "list", [
		(0x00, table.sym_var("next", "struct list *")),
		(0x04, table.sym_var("prev", "struct list *")),
	]],
	[0x68, "struct", "objlist", [
		(0x000, table.sym_var("s", "S_OBJECT")),
		(0x060, table.sym_var("next", "struct objlist *")),
		(0x064, table.sym_var("prev", "struct objlist *")),
	]],
	[0x260, "struct", "object", [
		(0x000, table.sym_var("list", "OBJLIST")),
		...
		(0x076, table.sym_var("col_count", "s16")),
		(0x078, table.sym_var("obj_col", "struct object *", "[4]")),
		[0x088, "union", "mem", [
			(None, table.sym_var("s", "s16", "[2]")),
			(None, table.sym_var("i", "s32")),
			(None, table.sym_var("f", "f32")),
			(None, table.sym_var("p", "void *")),
		], "[80]"],
...
struct_map = [
	[0x28, "struct", "plane", [
		(0x00, table.sym_var("_00", "short")),
		(0x02, table.sym_var("_02", "short")),
		(0x04, table.sym_var("_04", "short")),
		(0x06, table.sym_var("_06", "short")),
		(0x08, table.sym_var("_08", "short")),
		(0x0A, table.sym_var("_0A", "short")),
		(0x0C, table.sym_var("_0C", "short")),
		(0x0E, table.sym_var("_0E", "short")),
		(0x10, table.sym_var("nx", "float")),
		(0x14, table.sym_var("ny", "float")),
		(0x18, table.sym_var("nz", "float")),
		(0x1C, table.sym_var("nw", "float")),
		(0x20, table.sym_var("_20", "short")),
		(0x22, table.sym_var("_22", "short")),
		(0x24, table.sym_var("_24", "short")),
		(0x26, table.sym_var("_26", "short")),
	]],
	[0x30, "struct", "bgface", [
		(0x00, table.sym_var("code", "s16")),
		(0x02, table.sym_var("arg", "s16")),
		(0x04, table.sym_var("flag", "s8")),
		(0x05, table.sym_var("area", "AREA")),
		(0x06, table.sym_var("yl", "short")),
		(0x08, table.sym_var("yh", "short")),
		...
		(0x2C, table.sym_var("obj", "OBJECT *")),
	]],
	[0x08, "struct", "bglist", [
		(0x00, table.sym_var("next", "struct bglist *")),
		(0x04, table.sym_var("face", "BGFACE *")),
	]],
	[0x18, "struct", "bgroot", [
		(0x00, table.sym_var("list", "BGLIST", "[3]")),
	]],
	[0x28, "struct", "wall_check", [
		(0x00, table.sym_var("x", "float")),
		(0x04, table.sym_var("y", "float")),
		(0x08, table.sym_var("z", "float")),
		(0x0C, table.sym_var("offset", "float")),
		(0x10, table.sym_var("radius", "float")),
		(0x14, table.sym_var("flag", "s16")),
		(0x16, table.sym_var("count", "s16")),
		(0x18, table.sym_var("wall", "BGFACE *", "[4]")),
	]],
]

struct_camera = [
	[0x24, "struct", "pl_camera", [
		(0x00, table.sym_var("state", "u32")),
		(0x04, table.sym_var("pos", "VECF")),
		(0x10, table.sym_var("ang", "VECS")),
		(0x16, table.sym_var("neck_x", "short")),
		(0x18, table.sym_var("neck_y", "short")),
		(0x1A, table.sym_var("eyes", "s16")),
		(0x1C, table.sym_var("glove", "s16")),
		(0x1E, table.sym_var("demo", "s16")),
		(0x20, table.sym_var("obj", "OBJECT *")),
	]],
	[0xC0, "struct", "camdata", [
		(0x00, table.sym_var("_00", "VECF")),
		(0x0C, table.sym_var("_0C", "VECF")),
		(0x18, table.sym_var("_18", "VECF")),
		(0x24, table.sym_var("_24", "VECF")),
		(0x30, table.sym_var("_30", "VECF")),
		(0x3C, table.sym_var("_3C", "u8")),
		(0x3D, table.sym_var("_3D", "u8")),
		(0x40, table.sym_var("_40", "f32")),
		(0x44, table.sym_var("_44", "f32")),
		(0x48, table.sym_var("_48", "f32")),
		(0x4C, table.sym_var("_4C", "VECS")),
		(0x52, table.sym_var("_52", "VECS")),
		(0x58, table.sym_var("_58", "s16")),
		(0x5A, table.sym_var("_5A", "s16")),
		(0x5C, table.sym_var("_5C", "s16")),
		(0x60, table.sym_var("_60", "VECF")),
		(0x6C, table.sym_var("_6C", "VECS")),
		(0x72, table.sym_var("_72", "s16")),
		(0x74, table.sym_var("_74", "s16")),
		(0x76, table.sym_var("_76", "s16")),
		(0x78, table.sym_var("_78", "s16")),
		(0x7A, table.sym_var("_7A", "s16")),
		(0x7C, table.sym_var("_7C", "s16")),
		(0x7E, table.sym_var("_7E", "s16")),
		(0x80, table.sym_var("look", "VECF")),
		(0x8C, table.sym_var("eye", "VECF")),
		(0x98, table.sym_var("_98", "s16")),
		(0x9A, table.sym_var("_9A", "s16")),
		(0x9C, table.sym_var("_9C", "s16")),
		(0x9E, table.sym_var("_9E", "s16")),
		(0xA0, table.sym_var("_A0", "s16")),
		(0xA2, table.sym_var("_A2", "s16")),
		(0xA4, table.sym_var("_A4", "f32")),
		(0xA8, table.sym_var("_A8", "f32")),
		(0xAC, table.sym_var("_AC", "f32")),
		(0xB0, table.sym_var("_B0", "f32")),
		(0xB4, table.sym_var("_B4", "s16")),
		(0xB8, table.sym_var("_B8", "u32")),
		(0xBC, table.sym_var("_BC", "s16")),
	]],
	[0x01, "struct", "camera", [
...
struct_scene = [
	...
	[0x08, "struct", "connect", [
		(0x00, table.sym_var("flag", "u8")),
		(0x01, table.sym_var("port", "u8")),
		(0x02, table.sym_var("offset", "VECS")),
	]],
	[0x0A, "struct", "wind", [
		(0x00, table.sym_var("_00", "short")),
		(0x02, table.sym_var("_02", "short")),
	...
	[0x3A, "struct", "scene", [
		...
		(0x04, table.sym_var("shp", "S_SCENE *")),
		(0x08, table.sym_var("map", "MAP *")),
		(0x0C, table.sym_var("area", "AREA *")),
		(0x10, table.sym_var("tag", "TAG *")),
		(0x14, table.sym_var("port", "PORT *")),
		(0x18, table.sym_var("bgport", "BGPORT *")),
		(0x1C, table.sym_var("connect", "CONNECT *")),
		(0x20, table.sym_var("spawn", "SPAWN *")),
		(0x24, table.sym_var("cam", "CAMERA *")),
		(0x28, table.sym_var("wind", "WIND *")),
		(0x2C, table.sym_var("jet", "JET *", "[2]")),
...
struct_player = [
	...
	[0xC8, "struct", "player", [
		...
		(0x60, table.sym_var("wall", "BGFACE *")),
		(0x64, table.sym_var("roof", "BGFACE *")),
		(0x68, table.sym_var("ground", "BGFACE *")),
		...
		(0x78, table.sym_var("obj_col", "OBJECT *")),
		(0x7C, table.sym_var("obj_hold", "OBJECT *")),
		(0x80, table.sym_var("obj_use", "OBJECT *")),
		(0x84, table.sym_var("obj_ride", "OBJECT *")),
		(0x88, table.sym_var("obj", "OBJECT *")),
		(0x8C, table.sym_var("spawn", "SPAWN *")),
		(0x90, table.sym_var("scene", "SCENE *")),
		(0x94, table.sym_var("camera", "PL_CAMERA *")),
		(0x98, table.sym_var("shape", "PL_SHAPE *")),
		(0x9C, table.sym_var("cont", "CONTROLLER *")),
		(0xA0, table.sym_var("anime", "BANK *")),
